...
import type {Customer, Driver, OrderRow, Payment, Product, Receipt, Route, Supplier} from "../../types/Types.ts";
...
type TableProps = {
    columns: GridColDef[];
    typeOf: string;
    rows: (Product | Customer | OrderRow | Driver | Route | Receipt | Supplier | Payment)[];
    loading: boolean;
    rowCount: number;
